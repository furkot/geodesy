 ...
 */
export function distance(from, to, radius = 6371e3) {
 ...
 */
export function alongTrackDistance(point, start, end, radius = 6371e3) {
 ...
 */
export function crossTrackDistance(point, start, end, radius = 6371e3) {
  if (start[0] === point[0] && start[1] === point[1]) {
    return 0;
  }
