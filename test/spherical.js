...
test('distance', t => {
  t.assert.equal(distance(cambridge, paris).toFixed(), '404732');
  t.assert.equal(distance(cambridge, paris, R).toFixed(), '404279');
...
test('alongTrackDistance', t => {
  t.assert.equal(alongTrackDistance(dunham, bradwell, partney).toPrecision(4), '6.240e+4');
  t.assert.equal(alongTrackDistance(dunham, bradwell, partney, R).toPrecision(4), '6.233e+4');

  t.assert.equal(alongTrackDistance([1, 1], [0, 0], [2, 0], R).toPrecision(4), '1.112e+5');
  t.assert.equal(alongTrackDistance([1, -1], [0, 0], [2, 0], R).toPrecision(4), '1.112e+5');
  t.assert.equal(alongTrackDistance([-1, -1], [0, 0], [2, 0], R).toPrecision(4), '-1.112e+5');
  t.assert.equal(alongTrackDistance([-1, 1], [0, 0], [2, 0], R).toPrecision(4), '-1.112e+5');
  t.assert.equal(alongTrackDistance([0, 10], [0, 10], [2, 0], R), 0);
...
test('crossTrackDistance', t => {
  t.assert.equal(crossTrackDistance(dunham, bradwell, partney).toPrecision(4), '-307.9');
  t.assert.equal(crossTrackDistance(dunham, bradwell, partney, R).toPrecision(4), '-307.5');

  t.assert.equal(crossTrackDistance([1, 10], [0, 0], [2, 0], R).toPrecision(4), '-1.112e+6');

  t.assert.equal(crossTrackDistance([1, 1], [0, 0], [2, 0], R).toPrecision(4), '-1.112e+5');
  t.assert.equal(crossTrackDistance([1, -1], [0, 0], [2, 0], R).toPrecision(4), '1.112e+5');
  t.assert.equal(crossTrackDistance([-1, -1], [0, 0], [2, 0], R).toPrecision(4), '1.112e+5');
  t.assert.equal(crossTrackDistance([-1, 1], [0, 0], [2, 0], R).toPrecision(4), '-1.112e+5');
  t.assert.equal(crossTrackDistance([0, 10], [0, 10], [2, 0], R), 0);
